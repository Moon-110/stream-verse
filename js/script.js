...
const displayVideos = (videos) =>{
    ...
    <img
      ...
      ${videos.others.posted_date?.length == 0 ? "": `<span class="absolute text-xs right-2 bottom-2 bg-black rounded p-1 text-white">${getTimeString(videos.others.posted_date)}</span>`}
  ...
  <div class="px-0 py-2 flex gap-2">
    ...
    <div>
        ...
        <div class="flex justify-center items-center gap-2">
         <p class="text-gray-400 py-0">${videos.authors[0].profile_name}</p>
